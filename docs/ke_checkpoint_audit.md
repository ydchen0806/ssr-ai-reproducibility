...
Displayed main-text panels report n=3–5 pairs. Counts below are historical campaign files searched for exported weights, not the displayed seed lists.

| Cohort | Completed result records | Exported trained-weight files found |
| --- | ---: | ---: |
| WikiRecent rank-8 100-edit trajectory (historical campaign files) | 20 | 0 |
| WikiRecent/WikiCounterFact ranks 8/16/32/64 (historical campaign files) | 160 | 0 |
